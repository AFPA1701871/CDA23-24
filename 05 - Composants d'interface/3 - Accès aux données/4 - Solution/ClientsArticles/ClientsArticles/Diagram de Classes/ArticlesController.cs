...
namespace ClientsArticles.Controllers
{
    ...
    public class ArticlesController:ControllerBase
    {
        ...
        public ActionResult<ArticlesDtoAvecCategorie> GetArticleById(int id)
        {
        ...
        public ActionResult<ArticlesDtoOUT> CreateArticle(ArticlesDtoIN art)
        {
            ...
            return CreatedAtRoute(nameof(GetArticleById), new { Id = a.IdArticle }, a);
        }

        [HttpPut("{id}")]
        public ActionResult UpdateArticle(int id, ArticlesDtoIN art)
        {
